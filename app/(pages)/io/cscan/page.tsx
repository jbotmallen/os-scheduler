...
import { BirdIcon, CalculatorIcon, HardDriveIcon, ScanFaceIcon, TableIcon } from "lucide-react";

const CScan = () => {
    const { operations, setOperations, headPosition, setHeadPosition, diskEnd, setDiskEnd } = useIO();
    ...
    const calculateCScan = () => {
        ...
        const fullPath = [
            headPosition,
            ...right,
            diskEnd, // Go to the end of the disk
